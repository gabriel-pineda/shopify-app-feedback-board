...
export default function Roadmap() {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    if ((window as any).loadRoadmap) {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      (window as any).loadRoadmap(TARGET_CONTAINER_ID);
      return;
    }
    ...
    script.setAttribute("show_create_post_button", "true");
    script.setAttribute("color_mode", "light"); // or "dark"
    script.setAttribute("show_roadmap", "true");
